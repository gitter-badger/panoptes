                            ...
                            ('SummaryValues', {
                                   ...
                                   'children': OrderedDict(( 
                                                ...
                                                ('MinVal', {
                                                           ...
                                                           'required': False,
                                                           'default': 0,
                                                           'description': 'Value used for lower extent of scales, only specified at this level for reference tracks'
                                                           }),
                                                ('MaxVal', {
                                                           'type': 'Value',
                                                           'required': False,
                                                           'default': 1,
                                                           'description': 'Value used for upper extent of scales, only specified at this level for reference tracks'
                                                           }),
                                                ))
                                               })
                          ))
